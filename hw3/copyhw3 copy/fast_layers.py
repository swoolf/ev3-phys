import numpy as np
try:
  from hw3.im2col_cython import col2im_cython, im2col_cython
  from hw3.im2col_cython import col2im_6d_cython
except ImportError:
  print 'run the following from the hw3 directory and try again:'
  print 'python setup.py build_ext --inplace'
  print 'You may also need to restart your iPython kernel'

from hw3.im2col import *
